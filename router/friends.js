...
router.get("/:email",(req,res)=>{
  // Retrieve the email parameter from the request URL and send
  // the corresponding friend's details
...
router.put("/:email", (req, res) => {
  ...
  if (friend) { // Check if friend exists
    ...
    friends[email] = friend; // Update friend details in 'friend' object
